  ...
  let object={
    ...
    defaultProps(){
      return {
        ...
        pointFutureColor:'rgba(0,0,0,0)',
        pointPresentColor:null,
        pointPastColor:null,

        fontPastColor:'#666',
        fontPresentColor:'rgba(0,0,0,0)',
        fontFutureColor:'rgba(0,0,0,0)',
      }
    },
    get trailColor(){
      if(typeof this.props !='undefined')
        if(this.props.trailColor!=null) return this.props.trailColor
      if(this.trailPath==null) return 'rgba(0,0,0,0)'
    ...
    renderMap(){
      ...
      let drawImagePointer=(image)=>{
        ...
        let drawTriangle=(corner1,corner2)=>{
          ...
          this.ctx.fillStyle=`rgba(135, 38, 113,${colorValue})`
      ...
      if(blendWorks){
        gradient.addColorStop(0,'rgb(214, 233, 195)')
        gradient.addColorStop(1,"rgba(214, 233, 195, 0)")
        // gradient.addColorStop(0,'rgb(156, 190, 119)')
